...
flags.DEFINE_string(
    "input_file2", None,
    "Input TF example files (can be a glob or comma separated).") ### this is the valid set
...
def main(_):
  ...
  input_files2 = []
  for input_pattern2 in FLAGS.input_file2.split(","):
    input_files2.extend(tf.gfile.Glob(input_pattern2))
